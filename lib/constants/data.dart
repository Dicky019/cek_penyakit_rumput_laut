...
""",
  ...
  static const listJenisRumputlaut = [
    JenisRumputLautModel(
      title: "Ice-Ice",
      deskripsi:
          """Alga merah merupakan kelompok rumput laut dengan jumlah spesies paling banyak, yaitu sekitar 6000 jenis (Algaebase.org). Salah satu jenis alga merah yang telah banyak dimanfaatkan ialah Kappaphycus alvarezii. Rumput laut merah mempunyai kenampakan warna talus yang bervariasi. Warna talus yang bervariasi disebabkan adanya komposisi pigmen yang terdiri dari klorofil a, klorofil d, dan fikobiliprotein (R-fikosianin, allofikosianin serta fikoeritrin).  Fikoeritrin merupakan pigmen dominan pada alga merah. Pigmen tersebut memberikan kenampakan warna merah pada alga. Alga merah mempunyai kemampuan adaptasi kromatik, yaitu penyesuaian warna talus berdasarkan kualitas pencahayaan yang diterima.""",
      imagePath: 'assets/images/ice-ice.jpg',
    ),
    JenisRumputLautModel(
      title: "Kerak Bryzoan",
      deskripsi:
          "Jenis rumput laut dari kelas Chlorophyceae umumnya berwarna hijau dengan bentuk talus berupa lembaran, batangan atau bulatan yang bersifat lunak, keras atau siphonous, terdiri atas uniseluler atau multiseluler. Caulerpa sp. merupakan salah satu jenis rumput laut dari kelas Chlorophyceae. Caulerpa sp. merupakan rumput laut yang sering dikonsumsi sebagai sayuran dan lalapan di daerah tropikal Pasifik terutama di Filipina dan Indonesia. Caulerpa sp. mempunyai kandungan gizi yang cukup tinggi, antara lain protein (10,7%) dan karbohidrat (27,2%), sedangkan lemaknya bersifat fluktuatif yaitu sekitar 0,3%, kandungan air antara 16–20%, serta kandungan serat kasar berkisar antara 4,4–15,5% . Caulerpa sp. merupakan salah satu jenis alga yang mempunyai kesamaan komposisi pigmen dengan tumbuhan tingkat tinggi. Jenis rumput laut yang termasuk dalam kelompok alga hijau mempunyai pigmen fotosintetik yaitu klorofil a dan b dengan jumlah yang melimpah. Selain pigmen utama yang berupa klorofil, alga hijau juga mempunyai beberapa pigmen asesoris, yaitu karotenoid. Karotenoid utama pada alga hijau diantaranya β-karoten, lutein, v iolaxanthin, antheraxanthin, zeaxanthin, dan neoxanthin.",
      imagePath: 'assets/images/kerak_bryzoan.jpeg',
    ),
    JenisRumputLautModel(
      title: "Bulu Kucing",
      deskripsi:
          "Alga coklat mempunyai bentuk yang bervariasi tetapi hampir sebagian besar berwarna coklat atau pirang. Warna tersebut tidak berubah walaupun alga ini telah dikeringkan. Alga coklat mengandung beberapa pigmen fotosintetik yaitu karoten, fukoxantin, klorofil a, dan klorofil c. Sargassum sp. merupakan rumput laut yang termasuk dalam kelas Phaeophyceae. Di Indonesia, Sargassum sp. memiliki sebaran yang luas dan bervariasi. Jenis rumput laut tersebut termasuk tumbuhan yang dominan dan terdistribusi di seluruh perairan Indonesia, antara lain di Selat Sunda, Perairan Bangka Belitung, Karimunjawa, Pantai Selatan Pulau Jawa, Pantai Bali, Pantai Lombok, Kupang, Kalimantan Timur, Sulawesi Tenggara, Sulawesi Utara, Ternate, Ambon, Teluk Lampung, dan Perairan Natuna. Sargassum sp. mempunyai banyak senyawa yang dapat dimanfaatkan untuk berbagai keperluan. Kandungan senyawa kimia utama Sargassum sp. antara lain, alginat, protein, vitamin C, tanin, yodium, dan fenol (obat gondok, anti bakteri dan tumor). Kandungan koloid alginat dari Sargassum sp. sangat penting, karena digunakan cukup luas dalam industri, yaitu sebagai bahan pengental, pensuspensi, penstabil, pembentuk film, gel, disintegrating agent, dan bahan pengemulsi. Sehubungan dengan fungsi tersebut, maka alginat banyak dibutuhkan untuk berbagai industri, seperti farmasi (5%), tekstil (50%), makanan dan minuman (30%), kertas (6%), dan industri lainnya (9%). Sargassum sp. juga mengandung pigmen fotosintetik.",
